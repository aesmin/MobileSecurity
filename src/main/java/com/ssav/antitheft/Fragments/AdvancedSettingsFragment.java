...
public class AdvancedSettingsFragment extends PreferenceFragment {
    ...
    public void onResume() {
        ...
        final SwitchPreference  googleAccount = (SwitchPreference ) findPreference("google_account_chosen");
        final SwitchPreference  dropboxAccount = (SwitchPreference) findPreference("dropbox_account_chosen");
